...
var bartStation = [
    {
        ...
        "rating": 3,
        "coordinates": {
            "lat": 37.8033590838803,
            "lng": -122.271844493925
        },
        "transactions": [],
        "location": {
...
// we used, 40.7413549, -73.99802439999996 or your own!
    ...
    var marker = new google.maps.Marker({
        map: map,
        position: bartStation[0].coordinates,
        title: bartStation[0].main,
    });
};
...
var ViewModel = function () {
    ...
    self.bartList = ko.observableArray([]);

    bartStation.forEach(function(data) {
        self.bartList.push(new bart(data));
    });
    ...
    //     map: map,
    //     position: bartList()[0].coordinates,
    //     title: bartList()[0].main,
    // });
